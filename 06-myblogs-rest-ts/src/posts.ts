...
const SAMPLE_POSTS = [
    new Post(0, "New in TypeScript", "TypeScript becomes stricter ...", ['typescript', 'novelties'], 
    ...
    new Post(0, "New in EcmaScript", "Private fields were added to ES2021 ...", ['es', 'private', 'novelties'], 
    "http://doctorakil.com/wp-content/uploads/2018/01/coffee-940x600.jpg", 1),
    new Post(0, "Async Composition using Async/Await", 
